...
if(isset($_GET['sub_cat'])){
    ...
    $query = "SELECT name, price, image_1, id FROM product WHERE category = 'electronics' AND sub_category = '{$sub_category}'";
}
else{
    $query = "SELECT name,price,image_1,id FROM product WHERE category = 'electronics'";
}
...
//                            while($row = mysqli_fetch_assoc($rslt)){
                            ...
                            <div class="grid_1_of_4 images_1_of_4">
                                <h4 style="min-height: 4.5em"><a href="preview_edit.php?table=electronics&id=<?php  echo $prod_id ?>"><?php echo strlen($prod_name) > 50 ? substr($prod_name,0,50)."..." : $prod_name; ?></a></h4>
                                ...
                                <div class="price-details">
                                    ...
                                    <div class="add-cart">								
                                        <h4><a href="preview_edit.php?table=electronics&id=<?php  echo $prod_id ?>">More Info</a></h4>
                                    </div>
                                    <div class="clear"></div>
                                </div>					 
                            </div>   
