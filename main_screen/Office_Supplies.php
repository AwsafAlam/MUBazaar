...
if(isset($_GET['sub_cat'])){
    ...
    $query = "SELECT name, price, image_1, id FROM product WHERE category = 'office_supplies' AND sub_category = '{$sub_category}'";
}
else{
    $query = "SELECT name,price,image_1,id FROM product WHERE category = 'office_supplies'";
}
...
//                                echo "<h1 style='color:red;text-weight:bold'>NO PRODUCT FOUND FOR YOUR SEARCH!</h1>";
                                        ...
                                        while ($row = mysqli_fetch_assoc($rslt)) {
                                            ...
                                            ?>
                                            <a href="preview_edit.php?table=<?php echo  $single_table; ?>&id=<?php echo $prod_id; ?>" title="img1"> <img src="images/<?php echo $single_table . "/" . $prod_image_1 ; ?>" width="100px" height="100px" alt="<?php echo $prod_name;?>"/>
...
//
//                                $sub_category = $_GET['sub_cat'];
//                                $query = "SELECT name, price, image_1, id FROM electronics WHERE sub_category = '{$sub_category}';";
//                            }
//                            else{
//                                $query = "SELECT name,price,image_1,id FROM electronics";
//                            }
//
//                            $rslt = mysqli_query($connect,$query);
//                            while($row = mysqli_fetch_assoc($rslt)){
                            for ($p = 0; $p < count($results->data); $p++){
                                $product = $results->data[$p]; 
                                $prod_name = $product['name'];
                                $prod_price = $product['price'];
                                $prod_image_1 = $product['image_1'];
                                $prod_id = $product['id'];
                            ...
                            <div class="grid_1_of_4 images_1_of_4">
                                <h4 style="min-height: 4.5em"><a href="preview_edit.php?table=office_supplies&id=<?php  echo $prod_id ?>"><?php echo strlen($prod_name) > 50 ? substr($prod_name,0,50)."..." : $prod_name; ?></a></h4>
                                <a href="preview_edit.php?table=office_supplies&id=<?php  echo $prod_id ?>"><img  width="120" height="120" src="images/office_supplies/<?php echo $prod_image_1?>" alt="" /></a>
                                <div class="price-details">
                                    ...
                                    <div class="add-cart">								
                                        <h4><a href="preview_edit.php?table=office_supplies&id=<?php  echo $prod_id ?>">More Info</a></h4>
                                    </div>
                                    <div class="clear"></div>
                                </div>					 
                            </div>   
