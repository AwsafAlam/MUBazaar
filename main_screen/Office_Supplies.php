...
if(isset($_GET['sub_cat'])){
    ...
    $query = "SELECT name, price, image_1, id FROM office_supplies WHERE sub_category = '{$sub_category}'";
}
else{
    $query = "SELECT name,price,image_1,id FROM office_supplies";
}
...
//                            while($row = mysqli_fetch_assoc($rslt)){
                            ...
                            <div class="grid_1_of_4 images_1_of_4">
                                <h4 style="min-height: 4.5em"><a href="preview_edit.php?table=office_supplies&id=<?php  echo $prod_id ?>"><?php echo $prod_name ?></a></h4>
