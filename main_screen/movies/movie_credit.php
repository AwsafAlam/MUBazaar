...
//        $checkout_cvv = $_POST['checkout_cvv'];
        ...
        if(mysqli_num_rows($rslt) != 0){
            ...
            $cart_query = "SELECT movie_id FROM movie_cart WHERE customer_id = {$customer_id};";

            $cart_rslt = mysqli_query($connect, $cart_query);

            while($query_rows = mysqli_fetch_assoc($cart_rslt)) {

                $movie_id = $query_rows['movie_id'];


                $movie_customer_query = "INSERT INTO movie_customer (movie_id, customer_id) VALUES({$movie_id}, {$customer_id} );";
                mysqli_query($connect, $movie_customer_query);


                $delete_query = "DELETE FROM movie_cart WHERE customer_id = {$customer_id};";
                mysqli_query($connect, $delete_query);

                $update_sold_query = "UPDATE movie SET sold = sold + 1 WHERE id = {$movie_id};";
                mysqli_query($connect, $update_sold_query);


                $reduce_balance_query = "UPDATE credit_card SET Credit_Balance = Credit_Balance - {$total_cost} ";
                $reduce_balance_query .= "WHERE Credit_No = '{$credit_card_no}' AND Card_Type = '{$card_type}';";
            ...
            echo "<script>alert('Password or CVV mismatch')</script>";
        }
                ...
                <div class="col-xs-12 col-md-4">
                    ...
                    <div class="panel panel-default credit-card-box">
                        ...
                        <div class="panel-body">
                            <form action="movie_credit.php?card_type=<?php echo $card_type ?>" role="form" id="checkout-form" method="post">
                                <div class="row">
                                    <div class="col-xs-12">
...
<!--                                             Split button-->
                                            <div class="btn-group btn-block">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a href="movie_credit.php?card_type=visa">Visa</a></li>
                                                    <li><a href="movie_credit.php?card_type=master">Master Card</a></li>
                                                    <li><a href="movie_credit.php?card_type=american_express">American Express Card</a></li>
                                                </ul>
                                            </div>
