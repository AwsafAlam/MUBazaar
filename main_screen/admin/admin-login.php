    ...
    <body>
        ...
        <div class="login">
            ...
            <form action="" method="post" class="login-form">
                <input class="login-input" type="email" name="admin_email" placeholder="Email"/>
                ...
                if(isset($_POST['admin_login_submit'])){
                    ...
                    if(isset($_SESSION['customer_id'])){
                        ...
                        $admin_input_email = $_POST['admin_email'];
                        $admin_input_password = $_POST['admin_password'];
                        $query = "SELECT * ";
                        $query .= "FROM admin ";
                        $query .= "WHERE admin_email = '{$admin_input_email}' ;";


                        $admin_select_query = mysqli_query($connect,$query);
                        $num_rows = mysqli_num_rows($admin_select_query);
                        if($num_rows == 0){
                            echo "<p style='color:red;margin-top: 10px;font-weight:bold;''>No Account Found For This Email</p>";
                        }
                        else{
